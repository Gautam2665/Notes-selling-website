...
import { AuthContext } from '../contects/AuthProvider'; // Ensure the correct path to AuthProvider
                        ...
                        <div className="divide-y divide-gray-200">
                            <form onSubmit={handleLogin} className="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                                ...
                                <p className="mt-4 text-sm text-gray-600">
                                    If you don't have an account? <Link to="/sign-up" className="text-blue-500 underline">Sign up</Link>
                                </p>
                                <div className="relative">
                                    <button type="submit" className="bg-blue-500 text-white rounded-md px-6 py-2">Login</button> {/* Change to "Login" */}
                                </div>
                            </form>
                        </div>

                        <hr />
                        <div className='flex w-full items-center flex-col mt-5 gap-3'> {/* Corrected gap class */}
                            <button onClick={handleGoogleLogin} className="block">
                                <img src={googleLogo} className='w-12 h-12 inline-block' alt="Google Logo" />
                                Login with Google
                            </button>
                        </div>
